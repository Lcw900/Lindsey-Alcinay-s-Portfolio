...
import portfolio21 from "../assets/img/portfolio/21.jpg";
import portfolio24 from "../assets/img/portfolio/24.jpg";
import portfolio26 from "../assets/img/portfolio/26.jpg";
            ...
            <div className="col-lg-10 offset-lg-1">
              <div className="row">
                  ...
                  <div className="single-portfolio">
                    ...
                    <div className="single-portfolio-hover d-flex align-items-center">
                      <div className="portfolio-hover-text ">
                        ...
                        <Link to="/portfolio-single#" className="d-block">
                          UI Design
                        </Link>
                      </div>
                ...
                <div className="col-lg-6 col-xl-4 col-12 single-portfolio-wrapper">
                  <div className="single-portfolio">
                    <div className="single-portfolio-thumb">
                      <img src={portfolio21} alt="portfolio21" />
                    </div>
                    <div className="single-portfolio-hover d-flex align-items-center">
                      <div className="portfolio-hover-text ">
                        <span>Business</span>
                ...
                <div className="col-lg-6 col-xl-4 col-12 single-portfolio-wrapper">
                  <div className="single-portfolio">
                    <div className="single-portfolio-thumb">
                      <img src={portfolio24} alt="portfolio24" />
                    </div>
                    <div className="single-portfolio-hover d-flex align-items-center">
                      <div className="portfolio-hover-text ">
                        <span>Business</span>
                ...
                <div className="col-lg-6 col-xl-4 col-12 single-portfolio-wrapper">
                  <div className="single-portfolio">
                    <div className="single-portfolio-thumb">
                      <img src={portfolio26} alt="portfolio26" />
                    </div>
                    <div className="single-portfolio-hover d-flex align-items-center">
                      <div className="portfolio-hover-text ">
                        <span>Business</span>
